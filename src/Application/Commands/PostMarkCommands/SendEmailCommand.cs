...
namespace Application.Commands.PostMarkCommands
{
    ...
    public class SendEmailCommand : IRequest<PostmarkResponse>
    {
    ...
    public class SendMessageHandler : IRequestHandler<SendEmailCommand, PostmarkResponse>
    {
        ...
        public async Task<PostmarkResponse> Handle(SendEmailCommand request, CancellationToken cancellationToken)
        {
...
";
            emailTemplate = emailTemplate.Replace("//CompanyName//", "SBC Training");
            emailTemplate = emailTemplate.Replace("//YOUR_LOGO_URL//", "https://sbcportal.ng//img/LogoSBC.png");
            ...
            emailTemplate = emailTemplate.Replace("//CompanyEmail//", "admin@sbcportal.com");
